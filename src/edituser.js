...
const Edituser =()=>{
    ...
    const{name,accno,email,phone,website} = user;
    ...
    return (
        ...
        style={{
            ...
            <Card style={{ width: '18rem' ,backgroundColor:"lightgray"}}>
                ...
                <div className='form-group'>
                    <p style={{marginRight:"200px"}}>Account No</p>
                    <input type='text' className='form-control '
                        placeholder='Enter Your Account No' name='accno' value={accno} onChange={e => onInputChange(e)}/>
                </div>
